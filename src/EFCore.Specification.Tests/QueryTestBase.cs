...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        {
            AssertQuery<Order>(os => os.Select(o => o.OrderID).Take(10).Average());
        }
        ...
        {
            AssertQuery<Order>(os => os.Select(o => o.OrderID).Take(10).Min());
        }
        ...
        {
            AssertQuery<Order>(os => os.Select(o => o.OrderID).Skip(10).Average());
        }
        ...
        {
            AssertQuery<Order>(os => os.Select(o => o.OrderID).Skip(10).Min());
        }

        [ConditionalFact]
        public virtual void Select_skip_sum()
        {
            AssertQuery<Order>(os => os.Select(o => o.OrderID).Skip(10).Sum());
        }
